    ...
    <div className="site-shell" dir="rtl">
      ...
      <main>
        <section id="home" className="hero-section"><div className="hero-backdrop" aria-hidden="true" /><div className="hero-glow hero-glow-one" aria-hidden="true" /><div className="hero-glow hero-glow-two" aria-hidden="true" /><div className="container hero-grid">
          ...
          <div className="hero-portrait" aria-label="طارق سلام - خبير الخدمات المالية والتأمين"><div className="portrait-aura" /><div className="portrait-card"><div className="portrait-monogram">TS</div><span>مسار واضح</span><strong>مستقبل أكثر أماناً</strong></div><div className="portrait-silhouette" aria-hidden="true"><div className="silhouette-head" /><div className="silhouette-body" /><div className="silhouette-tie" /></div><div className="portrait-caption"><span>طارق سلام</span><small>مدير مبيعات وتطوير فرق</small></div></div>
