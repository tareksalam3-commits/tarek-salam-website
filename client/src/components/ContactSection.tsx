          ...
          >
            ...
            <div className="p-6 rounded-xl bg-navy text-white">
              ...
              <div className="flex gap-3">
                ...
                <a href="https://github.com/tareksalammohamed" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-lg bg-white/10 flex items-center justify-center hover:bg-gold/20 transition-colors">
